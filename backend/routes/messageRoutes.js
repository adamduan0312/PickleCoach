...
router.post('/conversations', authenticate, requireVerifiedEmail, validateRequest(createConversationSchema), messageController.createConversation);
router.post('/send', authenticate, requireVerifiedEmail, validateRequest(sendMessageSchema), messageController.sendMessage);
